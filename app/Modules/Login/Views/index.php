...
<div class="zt-modal-overlay" ng-class="{'active': $root.showTermsModal}" ng-click="$root.showTermsModal = false" ng-controller="formController">
    <div class="zt-modal" ng-click="$event.stopPropagation()">
        ...
        <div class="zt-modal-body">
            <p class="terms-intro">
                Dear user of this system, this online system is owned by Oryn (hereinafter to be referred to as the Company). 
                By logging in the Oryn Admin Portal (hereinafter referred to as the System) you are accepting these terms and conditions of use;
            </p>
            <ol class="terms-list">
                ...
                <li>That you will keep your username and password and that you will remain responsible for confidentiality of your password even where you decide to change the same. Oryn is not liable for loss/stolen passwords and for any issues of security breach occurring as a result of that loss/theft.</li>
            ...
            <div ng-show="current_task === 'login'">
                ...
                <p class="legal-notice">
                    * By logging into this system you accept its <a href="javascript:void(0)" ng-click="$root.showTermsModal = true" style="color: var(--zt-accent); text-decoration: none; font-weight: 600;">terms and conditions</a> of use. 
                    Oryn retains the right to use the data provided in the system for any lawful purpose.
                </p>
            </div>

            <div ng-show="current_task === 'recover'">
                <p class="description">Oryn System Administrative Management Portal</p>
...
<div class="login-footer">
    <div>&copy; 2026 <span style="color: var(--zt-accent); font-weight: 500;">Oryn</span></div>
