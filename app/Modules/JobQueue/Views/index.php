<div id="page-content" class="px-4 py-4">
    ...
    echo '<p class="text-muted small mb-0">Monitor background tasks and system queues</p></div>';
    echo '</div>';
    ...
    if ($this->resultData['recordsFiltered'] > 0) {
        ...
        echo '<p class="text-muted">There are currently no background jobs matching your criteria.</p>';
        echo '</div>';
    }
    echo '</div>';
    ?>
